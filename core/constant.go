...
type MitmConfigParams struct {
	Enable          bool     `json:"enable"`
	CACertPEM       string   `json:"ca-cert"`
	CAKeyPEM        string   `json:"ca-key"`
	Domains         []string `json:"domains"`
	CaptureMaxBytes *int     `json:"capture-max-bytes"`
	StoreSize       *int     `json:"store-size"`
	SkipVerify      bool     `json:"skip-verify"`
	ScriptEnable    bool     `json:"script-enable"`
	ScriptURL       string   `json:"script-url"`
	ScriptToken     string   `json:"script-token"`
	ScriptTimeoutMs *int     `json:"script-timeout-ms"`
}
...
const (
	...
	setMitmConfigMethod            Method = "setMitmConfig"
	getHttpFlowsMethod             Method = "getHttpFlows"
	getHttpFlowMethod              Method = "getHttpFlow"
	clearHttpFlowsMethod           Method = "clearHttpFlows"
)
