...
const _$ActionMethodEnumMap = {
  ...
  ActionMethod.setMitmConfig: 'setMitmConfig',
  ActionMethod.getHttpFlows: 'getHttpFlows',
  ActionMethod.getHttpFlow: 'getHttpFlow',
  ActionMethod.clearHttpFlows: 'clearHttpFlows',
