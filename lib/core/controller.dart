...
class CoreController {
  ...
  Future<bool> setMitmConfig(Map<String, dynamic> config) async {
    return await _interface.setMitmConfig(config);
  }

  Future<List<dynamic>> getHttpFlows() async {
    return await _interface.getHttpFlows();
  }

  Future<Map<String, dynamic>?> getHttpFlow(String id) async {
    return await _interface.getHttpFlow(id);
  }

  Future<bool> clearHttpFlows() async {
    return await _interface.clearHttpFlows();
  }
}
