...
mixin CoreInterface {
  ...
  Future<bool> setMitmConfig(Map<String, dynamic> config);

  Future<List<dynamic>> getHttpFlows();

  Future<Map<String, dynamic>?> getHttpFlow(String id);

  Future<bool> clearHttpFlows();
}
...
abstract class CoreHandlerInterface with CoreInterface {
  ...
  @override
  Future<bool> setMitmConfig(Map<String, dynamic> config) async {
    return await _invoke<bool>(method: ActionMethod.setMitmConfig, data: config) ??
        false;
  }

  @override
  Future<List<dynamic>> getHttpFlows() async {
    return await _invoke<List<dynamic>>(method: ActionMethod.getHttpFlows) ?? [];
  }

  @override
  Future<Map<String, dynamic>?> getHttpFlow(String id) async {
    return await _invoke<Map<String, dynamic>>(
      method: ActionMethod.getHttpFlow,
      data: id,
    );
  }

  @override
  Future<bool> clearHttpFlows() async {
    return await _invoke<bool>(method: ActionMethod.clearHttpFlows) ?? false;
  }
}
