...
class FakeIpFilterItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    return ListItem.open(
      ...
      delegate: OpenDelegate<List<String>>(
        blur: false,
          ...
          ref
              ...
              .update(
                (state) => state.copyWith.dns(
                  fakeIpFilter: List<String>.from(items),
                ),
              );
        },
      ),
        ...
        onChanged: (items) {
          ...
          ref
              ...
              .update(
                (state) =>
                    state.copyWith.dns(
                      defaultNameserver: List<String>.from(items),
                    ),
              );
        },
      ),
      ...
      delegate: OpenDelegate<List<String>>(
        ...
        onChanged: (items) {
          ...
          ref
              ...
              .update(
                (state) =>
                    state.copyWith.dns(nameserver: List<String>.from(items)),
              );
        },
      ),
    );
...
class NameserverPolicyItem extends ConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    ...
    return ListItem.open(
      ...
      delegate: OpenDelegate<Map<String, String>>(
        blur: false,
        widget: MapInputPage(
        ...
        onChanged: (items) {
          ...
          ref
              ...
              .update(
                (state) =>
                    state.copyWith.dns(
                      proxyServerNameserver: List<String>.from(items),
                    ),
              );
        },
      ),
      ...
      delegate: OpenDelegate<List<String>>(
        ...
        onChanged: (items) {
          ...
          ref
              ...
              .update(
                (state) =>
                    state.copyWith.dns(fallback: List<String>.from(items)),
              );
        },
      ),
    );
          ...
          ref
              ...
              .update(
                (state) => state.copyWith.dns.fallbackFilter(
                  geosite: List<String>.from(items),
                ),
              );
        },
      ),
      ...
      delegate: OpenDelegate<List<String>>(
        ...
        onChanged: (items) {
          ...
          ref
              ...
              .update(
                (state) =>
                    state.copyWith.dns.fallbackFilter(
                      ipcidr: List<String>.from(items),
                    ),
              );
        },
      ),
