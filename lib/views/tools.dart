...
import 'package:fl_clash/views/config/mitm.dart';
  ...
  List<Widget> _getSettingList() {
    return generateSection(
      ...
      items: [
        ...
        const _ConfigItem(),
        if (system.isAndroid) const _MitmItem(),
...
class _MitmItem extends StatelessWidget {
  const _MitmItem();
  ...
  Widget build(BuildContext context) {
    return const ListItem.open(
      ...
      title: Text('MITM'),
      subtitle: Text('CA / 域名 / 脚本'),
      delegate: OpenDelegate(widget: MitmConfigView(), blur: false),
    );
  }
}
