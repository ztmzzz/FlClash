...
object State {
    ...
    suspend fun handleStartServiceAction() {
        runLock.withLock {
            ...
            // If Flutter is running and the tile plugin is attached, let Flutter drive start/stop.
            // Otherwise fall back to starting directly so quick actions remain reliable during engine init.
            if (flutterEngine != null && tilePlugin != null) {
                return
            }
